...
contract Minter {
    ...
    function buyToken(address _currency, uint256 _amount) public payable returns (bool success) {
        if (blocked) {
        ...
        uint256 _priceInCents = 100100 - (2 * _xDAO.balanceOf(address(this)) - _amount) / 2800;
        ...
        if (
            ...
            _tokenToGet.transferFrom(msg.sender, address(this), _mustChargeValue);
        }
        // ETH
            ...
            _mustChargeValue = (_amount * _priceInCents * _reserveETH) / (100 * _reserveBUSD);
        ...
        // WBNB
            ...
            (uint112 _reserveWBNB, uint112 _reserveBUSD, ) = _pair.getReserves();

            _mustChargeValue = (_amount * _priceInCents * _reserveWBNB) / (100 * _reserveBUSD);
        ...
        // BTCB
            ...
            (uint112 _reserveBTCB, uint112 _reserveBUSD, ) = _pair.getReserves();

            _mustChargeValue = (_amount * _priceInCents * _reserveBTCB) / (100 * _reserveBUSD);
